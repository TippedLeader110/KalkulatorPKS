...
import com.itcteam.kalkulatorpks.ui.about.material_balance.RecyclerFilterModal_mb;
import com.itcteam.kalkulatorpks.ui.about.material_balance.RecyclerListBerkas_mb;
...
public class ListBerkas_pr extends AppCompatActivity implements RecyclerFilterModal_pr.FilterModalListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daftarBerkas = getBerkas(4, false);

        recyclerListBerkas = new RecyclerListBerkas_pr(this, daftarBerkas, 4, export);
    ...
    public void prosesData(Boolean filter){
        daftarBerkas = getBerkas(4, filter);
