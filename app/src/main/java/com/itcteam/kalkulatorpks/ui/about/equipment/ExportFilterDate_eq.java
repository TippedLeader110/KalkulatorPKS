...
public class ExportFilterDate_eq extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseHandler databaseHandler = new DatabaseHandler(ExportFilterDate_eq.this);
                ExportCSV exportCSV = new ExportCSV(databaseHandler.getAllFilter(first, end, tipe), ExportFilterDate_eq.this);

                if (exportCSV.DoExportCSV("Filter"+ first +"-sd-"+end+"-OEE")){
                    Toast.makeText(ExportFilterDate_eq.this, "CSV Berhasil disimpan !!!", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(ExportFilterDate_eq.this, "Terjadi kesalahan !!!", Toast.LENGTH_SHORT).show();
                }
            }
        });
